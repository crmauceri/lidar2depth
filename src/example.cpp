...
public:
    ...
    */
    ...
    tf_listener_(tf_buffer_)
    {
        ...
        message_filters::Subscriber<PointCloud2> lidar_sub(nh_, "/X1/points", 1);
        message_filters::Subscriber<CameraInfo> info_sub(nh_, "/X1/front/camera_info", 1);
        TimeSynchronizer<PointCloud2, CameraInfo> sync(lidar_sub, info_sub, 10);

        sync.registerCallback(boost::bind(&Lidar2Depth::cloud_callback, this, _1, _2));
...
{
  // Initialize ROS
  ros::init (argc, argv, "ros_lidar2depth");

  // The meat and potatoes is in the Lidar2Depth class
  Lidar2Depth lidar2depth("X1/base_link/camera_front");
